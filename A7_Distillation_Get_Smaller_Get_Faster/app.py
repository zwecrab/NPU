...
def predict(model_name, text):
    ...
    prob_non_toxic = float(probs[0][0])
    prob_toxic = float(probs[0][1])

    # Determine classification
    if prob_toxic > 0.5:
        classification = "Toxic"
    elif prob_non_toxic > 0.5:
        classification = "Non-Toxic"
    else:
        classification = "50-50"

    return create_plot(prob_non_toxic, prob_toxic), classification
...
demo = gr.Interface(
    ...
    title="Zwe Htet (st125338): A7 - Distillation, Get Smaller, Get Faster",
